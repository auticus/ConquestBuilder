...
namespace ConquestController.Analysis.Components
{
    public class Defense : BaseComponent
    {
        ...
        public static double[] CalculateOutput(IConquestGamePiece model, List<int> defenseModificationValues, 
        ...
        /// <returns></returns>
        private static double[] CalculateDefenseBuffedForHalfAttacks(IConquestGamePiece model, List<int> defenseModificationValues, int standCount,
        ...
        /// <param name="noShields"></param>
        /// <returns></returns>
        private static double[] CalculateDefenseBuffed(IConquestGamePiece model, List<int> defenseModificationValues, int standCount,
            bool noShields = false)
        {
            model.Defense++;
        ...
        /// <param name="noShields"></param>
        /// <returns></returns>
        private static double[] CalculateDefense(IConquestGamePiece model, List<int> defenseModificationValues,
            int standCount, bool noShields = false) 
        {
