...
namespace ConquestController.Analysis.Components
{
    public class Defense : BaseComponent
    {
        ...
        public static double[] CalculateOutput<T>(ConquestGameElement<T> model, List<int> defenseModificationValues, 
        ...
        /// <returns></returns>
        private static double[] CalculateDefenseBuffedForHalfAttacks<T>(ConquestGameElement<T> model, List<int> defenseModificationValues, int standCount,
        ...
        /// <param name="noShields"></param>
        /// <returns></returns>
        private static double[] CalculateDefenseBuffed<T>(ConquestGameElement<T> model, List<int> defenseModificationValues, int standCount,
            bool noShields = false)
        {
            model.Defense++;
        ...
        /// <param name="noShields"></param>
        /// <returns></returns>
        private static double[] CalculateDefense<T>(ConquestGameElement<T> model, List<int> defenseModificationValues,
            int standCount, bool noShields = false) 
        {
